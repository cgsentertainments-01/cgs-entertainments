...
CREATE TABLE IF NOT EXISTS public.events (
    ...
    registration_form_type TEXT DEFAULT 'standard',
    participation_categories JSONB DEFAULT '["Solo", "Duo", "Group"]'::jsonb,
    dance_styles JSONB DEFAULT '["Classical", "Hip Hop", "Western"]'::jsonb,
    required_documents JSONB DEFAULT '["Profile Photo", "ID Proof", "Dance Video"]'::jsonb,
