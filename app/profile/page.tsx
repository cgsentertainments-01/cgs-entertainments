...
export default function ProfilePage() {
  ...
  return (
    ...
    >
      ...
      <div
        style={{ maxWidth: 1000, margin: "36px auto 64px", padding: "0 24px" }}
      ...
      >
        ...
        <div
          style={{
            background:
              "linear-gradient(135deg, #090314 0%, #1A0A3A 50%, #311068 100%)",
            borderRadius: 24,
            padding: "36px 40px",
            color: "#fff",
            display: "flex",
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                <Sparkles size={12} color="#C4B5FD" /> Official Participant
                Profile
              </div>
        ...
        {/* Quick Access Registrations & Payment History */}
        <div
          style={{
            marginTop: 24,
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            ...
            <div>
              ...
              >
                View your confirmed passes, payment transaction receipts, and
                entry QR codes synchronized from Supabase.
              </p>
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            >
              <ShieldCheck size={20} color="#16A34A" /> Security &amp;
              Verification
            </h3>
